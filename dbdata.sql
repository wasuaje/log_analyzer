...
CREATE TABLE "logfile" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL ,"nombre" VARCHAR NOT NULL ,"ruta" VARCHAR NOT NULL ,"server" INTEGER);
...
CREATE TABLE "registro" ("id" INTEGER PRIMARY KEY  NOT NULL ,"ip" VARCHAR,"fecha" DATETIME,"metodo" VARCHAR,"cod_retorno" VARCHAR,"request" VARCHAR,"user_agent" VARCHAR,"referrer" VARCHAR,"resolution" VARCHAR,"logfile" INTEGER);
DROP TABLE IF EXISTS "servidor";
CREATE TABLE "servidor" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "nombre" VARCHAR NOT NULL , "ip" VARCHAR NOT NULL );
